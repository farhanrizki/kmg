...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/bootstrap-extended.css">
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="<?php echo base_url();?>assets/images/pages/404.png" class="img-fluid align-self-center" alt="branding logo">
                                    <h1 class="font-large-2 my-1">404 - Page Not Found!</h1>
                                    <p class="p-2">
                                        We're sorry, the page you requested could not be found. Please go back to the homepage
                                    </p>
                                    <a class="btn btn-primary btn-lg mt-2" href="<?php echo base_url('home'); ?>">Back to Home</a>
                                </div>
                            </div>
                        </div>
                    </div>
